...
\begin{description}
	\item[\kw{EARG} : ] L'appel a été effectué avec de mauvais arguments.
	\item[\kw{EBUSY} : ] Le capteur est occupé, il doit être possible de
...
{La fonction doit retourner \kw{OK}, et le périphérique doit être fermé.}
...
à \kw{ERROR}, mais alors \kw{errno} doit être positionné à \kw{EBUSY}, et
