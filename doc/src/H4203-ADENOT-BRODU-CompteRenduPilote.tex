...
\Test{Fermeture d'un périphérique non ouvert}
{En utilisant \kw{remove}, on tente de fermer un périphérique qui n'est pas
    ouvert.}
{L'appel doit échouer, et \kw{errno} doit être positionné à \kw{ENOTOPENED}.}
\end{document}
